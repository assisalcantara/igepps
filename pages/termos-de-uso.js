          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900">
                Termos e Condições de Uso - IGEPPS Academy
              </h3>
            ...
            <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
              <dl className="sm:divide-y sm:divide-gray-200">
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">1. Aceitação dos Termos</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    Ao acessar e usar a plataforma IGEPPS Academy, você concorda em cumprir e estar vinculado a estes Termos de Uso e à nossa Política de Privacidade. Se você não concordar com qualquer parte dos termos, não poderá usar nossos serviços.
                  </dd>
                </div>
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">2. Descrição do Serviço</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    A IGEPPS Academy é uma plataforma de ensino a distância (EAD) que oferece cursos e materiais educacionais online para o desenvolvimento profissional de nossos usuários.
                  </dd>
                </div>
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">3. Contas de Usuário</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    Para acessar certos recursos, você pode ser solicitado a criar uma conta. Você é responsável por manter a confidencialidade de sua senha e por todas as atividades que ocorrem em sua conta.
                  </dd>
                </div>
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">4. Propriedade Intelectual</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    Todo o conteúdo presente na plataforma, incluindo textos, gráficos, logos, ícones, imagens, clipes de áudio e software, é propriedade da IGEPPS Academy ou de seus fornecedores de conteúdo e protegido pelas leis de direitos autorais.
                  </dd>
                </div>
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">5. Modificações nos Termos</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    Reservamo-nos o direito de modificar estes Termos de Uso a qualquer momento. A data da última atualização será sempre indicada no topo deste documento. É sua responsabilidade revisar os termos periodicamente.
                  </dd>
                </div>
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">6. Contato</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    Se você tiver alguma dúvida sobre estes Termos, entre em contato conosco através do e-mail: contato@igepps.com.br.
                  </dd>
                </div>
              </dl>
            </div>
